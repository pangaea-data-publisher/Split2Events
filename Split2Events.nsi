...
; License page
!insertmacro MUI_PAGE_LICENSE "C:\Users\rsieger\Documents\Development\Distribution\Split2Events\License\License.txt"
; Directory page
!insertmacro MUI_PAGE_DIRECTORY
; Instfiles page
!insertmacro MUI_PAGE_INSTFILES
; Finish page
!define MUI_FINISHPAGE_RUN "$INSTDIR\Split2Events.exe"
...
OutFile "C:\Users\rsieger\Documents\Development\Distribution\Split2Events_Win.exe"
InstallDir "$PROGRAMFILES\PANGAEA\Split2Events"
...
Section "MainSection" SEC01
  ...
  File "C:\Users\rsieger\Documents\Development\Distribution\Split2Events\Qt5Widgets.dll"
  File "C:\Users\rsieger\Documents\Development\Distribution\Split2Events\icudt54.dll"
  File "C:\Users\rsieger\Documents\Development\Distribution\Split2Events\icuin54.dll"
  File "C:\Users\rsieger\Documents\Development\Distribution\Split2Events\icuuc54.dll"
  ...
  CreateShortCut "$DESKTOP\Split2Events.lnk" "$INSTDIR\Split2Events.exe"
SectionEnd

Section -AdditionalIcons
  CreateShortCut "$SMPROGRAMS\PANGAEA\Split2Events\Uninstall.lnk" "$INSTDIR\uninst.exe"
SectionEnd

Section -Post
  WriteUninstaller "$INSTDIR\uninst.exe"
  WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$INSTDIR\Split2Events.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayName" "$(^Name)"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "UninstallString" "$INSTDIR\uninst.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\Split2Events.exe"
...
Section Uninstall
  ...
  Delete "$INSTDIR\Example\GeoB9528-3_data.txt"
  Delete "$INSTDIR\Example\GeoB9528-3_metadata.txt"
  ...
  RMDir "$SMPROGRAMS\PANGAEA\Split2Events"
