...
// Application constants
    ...
    const QString _VERSION_              = "12.31";	// Version number, 2017-07-05
...
// Constants
    ...
    const int   _MAX_NUM_OF_ISSUES       = 100000;   // maximum number of issues to handle, set 2017-06-17 (15.100 issues)
